...
| `cli.test.mjs`, `flow.test.mjs` | Initialization and entry (including the ignore rule check), the work order round trip, verdict enforcement, the commit completeness check, anomaly handling, and checkups through the project's commands and hook |
